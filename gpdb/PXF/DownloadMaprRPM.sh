...
DOWNLOAD_DIR="./MAPR"
PLATFORM="RHEL"  # RHEL, SLES, UBUNTU
...
# Default Hbase
MAPR_HBASE_RPM_RHEL=http://archive.mapr.com/releases/ecosystem-5.x/redhat/mapr-hbase-1.1.8.201711091319-1.noarch.rpm
...
# Default Hive
MAPR_HIVE_RPM_RHEL=http://archive.mapr.com/releases/ecosystem-5.x/redhat/mapr-hive-1.2.201710301200-1.noarch.rpm
